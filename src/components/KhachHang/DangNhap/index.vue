              ...
              <form class="row g-3">
                <div class="col-12">
                  ...
                  <input
                    ...
                    v-on:keyup.enter="actionDangNhap()"
                    class="form-control"
                ...
                <div class="col-12">
                  <div class="d-grid">
                    ...
                    >
                      <i class="fa-brands fa-google" style="color: #e81717"></i
    ...
    actionDangNhap() {
      ...
      axios
        ...
        .then(() =>
          axios
            .get(
              "http://127.0.0.1:8000/api/firebase/custom-token",
            ...
            .then(async (res) => {
              ...
              console.log("Received custom token from backend:", res);
