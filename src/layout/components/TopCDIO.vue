            ...
            <nav class="navbar navbar-expand">
                <router-link :to="'/'">
                    <a class="dropdown-item" :href="'/'">
                        <div class="topbar-logo-header d-flex align-items-center">
                            <img src="/src/assets/images/Remove-bg.ai_1727000743829.png" class="logo-icon" style="width: 120px;"
                                alt="logo icon">
                        </div>
                    </a>
                </router-link>
                ...
                <div class="search-bar flex-grow-1">
                    <div class="position-relative search-bar-box input-group w-100">
                        ...
                        <button class="btn btn-outline-secondary radius-30" type="button"
